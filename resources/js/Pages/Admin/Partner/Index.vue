...
/**************************************************************************************************************** */
    ...
    /******************************* en caso se active la parte de alertas aquí ver logica para boton *************************************/
    /******************************************************************************************************************/
        ...
        if (selectedRows.length > 0) {
            ...
            alert.fire({
                ...
                if (result.isConfirmed) {
                     confirmation(plataforma, BASE_URL+ '/partners' + id, '');
                    //confirmation(plataforma, 'https://reportes.kingtech.pe/partners' + id, '');
    ...
    const update = () => {
        ...
        if (selectedRows.length > 0) {
            ...
            formEdit.value.socios=selectedRowData.socios
        
            console.log(formEdit);
            //  sendRequest('PUT',formEdit.value,( BASE_URL +  '/partners'+id),'');
            sendRequest('PUT',formEdit.value,('https://reportes.kingtech.pe/partners/'+id),'');
    ...
    const save = () => 
        {     
            ...
            //  sendRequest('PUT',form.value,( BASE_URL +  '/partners'+id),'');
            sendRequest('POST',form.value,('https://reportes.kingtech.pe/partners'),'');
            ...
            <div className="md:col-span-12 lg:col-span-12 col-span-12">               
                ...
                >
                    ...
                    <tr>
                        ...
                        <th  class="px-4 py-2  ">Codigo Sede</th>

                        <!--  -->

                        <!-- <th  v-if="hasRole('atencion,supadmin')"  class="px-4 py-2  ">Alertar Cliente</th> -->
            ...
            <div class="bg-white rounded-lg shadow-lg max-w-md w-full h-full overflow-y-auto">
               ...
               <div class="p-4 space-y-4 overflow-y-auto">
                    <form @submit.prevent="update" classNaem="max-w-lg mx-auto border border-gray-300 p-6 my-5 rounded-lg overflow-y-auto">
                        ...
                        <div className="mb-4" >
                            <label for="plataforma" className="block mb-1">CODIGO DE SEDE</label>
            ...
            <div class="bg-white rounded-lg shadow-lg max-w-md w-full h-full overflow-y-auto">
                ...
                <div class="p-4 space-y-4 overflow-y-auto">
                    <form @submit.prevent="save" classNaem="max-w-lg mx-auto border border-gray-300 p-6 my-5 rounded-lg overflow-y-auto">
                        ...
                        <div className="mb-4" >
                            <label for="plataforma" className="block mb-1">CODIGO DE SEDE</label>
                            <input type="text" id="plataforma" className="form-input w-full" v-model="form.socios">
                            <p className="text-sm text-gray-500 mt-1">Ingrese el nombre de la plataforma.</p>
                        </div>
                        <div className="mb-4">
                            <label for="plataforma" className="block mb-1">MENSAJE</label>
