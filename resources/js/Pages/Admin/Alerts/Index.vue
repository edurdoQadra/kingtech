...
/**************************************************************************************************************** */
        ...
        if (selectedRows.length > 0) {
            ...
            alert.fire({
                ...
                if (result.isConfirmed) {
                     confirmation(plataforma, BASE_URL +'/alerts' + id, '');
                    //confirmation(plataforma, 'https://reportes.kingtech.pe/alerts' + id, '');
                }
            });
        } else {
    ...
    const update = () => {
        ...
        if (selectedRows.length > 0) {
            ...
            sendRequest('PUT',formEdit.value,( BASE_URL + '/alerts' + id  ),'');

            // sendRequest('PUT',formEdit.value,('https://reportes.kingtech.pe/alerts/'+id),'');
    ...
    const save = () =>
        {
            ...
            form.value.plataforma
             sendRequest('PUT',form.value,( BASE_URL + '/alerts' + id),'');
...
<!-- ****************************************************************************************************************************************************** -->
        ...
        <!-- ************************************************************************************************************************************** -->
        <div className="border px-5 py-5  border-primary-400 rounded-md   mb-3">
            <div className="md:col-span-12 lg:col-span-12 col-span-12">
                ...
                >
                    ...
                    <tr>
                        ...
                        <th  class="px-4 py-2  ">Codigo de Sede</th>
               ...
               <div class="p-4 space-y-4 overflow-y-auto">
                    <form @submit.prevent="update" classNaem="max-w-lg mx-auto border border-gray-300 p-6 my-5 rounded-lg overflow-y-auto">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="text" id="plataforma" className="form-input w-full" v-model="formEdit.alertas">
                            <p className="text-sm text-gray-500 mt-1">Ingrese el nombre de la plataforma.</p>
                        </div>
                        <div className="mb-4">
                            <label for="plataforma" className="block mb-1">MENSAJE</label>
                            <input type="text" id="plataforma" className="form-input w-full" v-model="formEdit.alertass">
                            <p className="text-sm text-gray-500 mt-1">Ingrese el nombre de la plataforma.</p>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow-lg max-w-md w-full h-full overflow-y-auto">
                ...
                <div class="p-4 space-y-4 overflow-y-auto">
                    <form @submit.prevent="save" classNaem="max-w-lg mx-auto border border-gray-300 p-6 my-5 rounded-lg overflow-y-auto">
                        ...
                        <div className="mb-4">
                            <label for="plataforma" className="block mb-1">CODIGO SEDE</label>
                            <input type="text" id="plataforma" className="form-input w-full" v-model="form.alertas">
                            <p className="text-sm text-gray-500 mt-1">Ingrese el nombre de la plataforma.</p>
                        </div>
                        <div className="mb-4">
                            <label for="plataforma" className="block mb-1">MENSAJE</label>
                            <input type="text" id="plataforma" className="form-input w-full" v-model="form.alertass">
                            <p className="text-sm text-gray-500 mt-1">Ingrese el nombre de la plataforma.</p>
                        </div>
                        ...
                        <div class="flex items-center justify-end p-4 border-t">
                    <button  type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5">Aceptar</button>
                    <button @click="showModal = false" type="button" class="ml-3 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-white px-5 py-2.5">Rechazar</button>
                </div>
                    </form>
                </div>
  ...
  <!-- ************************************************************************************************************************************** -->
        ...
        <div v-show="showModalUpload" id="default-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 overflow-y-auto">
             <div class="bg-white rounded-lg shadow-lg max-w-md w-full h-screen-70 overflow-y-auto">
                ...
                <!-- Modal body -->
                <div class="p-4 space-y-4 overflow-y-auto">
                    <form @submit.prevent="upload" enctype="multipart/form-data" class="max-w-lg mx-auto border border-gray-300 p-6 my-5 rounded-lg overflow-y-auto">
                        <div class="my-2">
