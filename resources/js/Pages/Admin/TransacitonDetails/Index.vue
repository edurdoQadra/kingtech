    ...
    if (selectedRows.length > 0) {
        ...
        alert.fire({
            ...
            if (result.isConfirmed) {
                // confirmation(plataforma, BASE_URL + '/transactiondetail' + id, '');
...
const update = () => {
 ...
 //  sendRequest('PUT',formEdit.value,(BASE_URL + '/transactiondetail'+id),'');
...
const save = () => 
    ...
    //  sendRequest('PUT',form.value,(BASE_URL + '/transactiondetail'+id),'');
