...
const deleteCliente = () => {
    ...
    if (selectedRows.length > 0) {
        ...
        // confirmation(plataforma, BASE_URL + '/locationlocal' + id, '');
        confirmation(contacto, 'https://reportes.kingtech.pe/locationlocal' + id, '');         
   }
        });
    } else {
...
const update = () => {
    ...
    if (selectedRows.length > 0) {
        ...
        console.log(formEdit);
 //  sendRequest('PUT',formEdit.value,( BASE_URL + '/locationlocal'+id),'');
 sendRequest('PUT',formEdit.value,('https://reportes.kingtech.pe/locationlocal/'+id),'');
...
const save = () => {
    ...
    //  sendRequest('PUT',form.value,('BASE_URL + /locationlocal'+id),'');
    sendRequest('POST',form.value,('https://reportes.kingtech.pe/locationlocal'),'');
...
<template>
        ...
        <!-- ************************************************************************************************************************************** -->         
        <div className="border px-5 py-5  border-primary-400 rounded-md  mt-3">    
                    ...
                    >
                        <thead>
                            <tr>
                                ...
                                <th className="px-4 py-2">nombre_sede</th>
