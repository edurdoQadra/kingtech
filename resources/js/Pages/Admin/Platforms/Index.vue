...
/**************************************************************************************************************** */
        ...
        if (selectedRows.length > 0) {
            ...
            alert.fire({
                ...
                if (result.isConfirmed) {
                    // confirmation(plataforma, BASE_URL + '/platforms' + id, '');
                    confirmation(plataforma, 'https://reportes.kingtech.pe/platforms' + id, '');
  ...
  //  sendRequest('PUT',formEdit.value,(BASE_URL + '/platforms'+id),'');
  sendRequest('PUT',formEdit.value,('https://reportes.kingtech.pe/platforms/'+id),'');
    ...
    const save = () => 
        {     
        console.log(form);
        //  sendRequest('PUT',form.value,(BASE_URL + '/platforms'+id),'');
        sendRequest('POST',form.value,('https://reportes.kingtech.pe/platforms'),'');
