...
/**************************************************************************************************************** */
    ...
    columns.value = [{ data:null,render:function(data,type,row,meta)
        {return (meta.row+1)}},
        {data:'codigo_sede'},
        {data:'codigo_plataforma'},
        {data:'codigo_cliente'},      
    ];
    /**************************************************************************************************************** */
    buttons.value = [
        {
            title: 'Plataforma Tienda',
            extend: 'excelHtml5',
    ...
    const deleteCliente = () => {
        ...
        if (selectedRows.length > 0) {
            ...
            // confirmation(plataforma, BASE_URL +'/platformstore' + id, '');
            confirmation(plataforma, 'https://reportes.kingtech.pe/platformstore' + id, '');
...
formEdit.value.codigo_cliente=selectedRowsData.codigo_cliente
    ...
    const update = () => {
        ...
        if (selectedRows.length > 0) {
            ...
            //  sendRequest('PUT',formEdit.value,(BASE_URL + '/platformstore'+id),'');
            sendRequest('PUT',formEdit.value,('https://reportes.kingtech.pe/platformstore/'+id),'');
    ...
    const save = () => 
        {     
            ...
            form.value.plataforma
                 //  sendRequest('PUT',form.value,(BASE_URL + '/platformstore'+id),'');
              sendRequest('POST',form.value,('https://reportes.kingtech.pe/platformstore'),'');
            ...
            <div className="md:col-span-12 lg:col-span-12 col-span-12">
                ...
                >
                    ...
                    <tr>
                        ...
                        <th  class="px-4 py-2  ">codigo_sede</th>
                        <th  class="px-4 py-2  ">Codigo de Plataforma</th>
                        <th  class="px-4 py-2  ">codigo_cliente</th>
                    </tr>
                    </thead>
                </DataTable>
